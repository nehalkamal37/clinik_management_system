...
use App\Http\Controllers\Dashboard\adminDataController;
...
//Route::get('login/admin', [adminController::class, 'create'])->name('login.admin');

Route::post('login/a', [adminController::class, 'store'])->name('login.admin');
