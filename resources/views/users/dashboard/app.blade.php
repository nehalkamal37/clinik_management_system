...
<head>
    ...
    <title>CLINIK - @yield('title')</title>
	...
	<!-- vector map CSS -->
    <link href="{{ asset('admin-dash/vendors/vectormap/jquery-jvectormap-2.0.3.css') }}" rel="stylesheet" type="text/css" />

    <!-- Toggles CSS -->
    <link href="{{ asset('admin-dash/vendors/jquery-toggles/css/toggles.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('admin-dash/vendors/jquery-toggles/css/themes/toggles-light.css') }}" rel="stylesheet" type="text/css">
	
	<!-- Toastr CSS -->
    <link href="{{ asset('admin-dash/vendors/jquery-toast-plugin/dist/jquery.toast.min.css') }}" rel="stylesheet" type="text/css">

    <!-- Custom CSS -->
    <link href="{{ asset('admin-dash/dist/css/style.css') }}" rel="stylesheet" type="text/css">
</head>
        ...
        <nav class="navbar navbar-expand-xl navbar-dark fixed-top hk-navbar">
            ...
            <ul class="navbar-nav hk-navbar-content">
                ...
                <li class="nav-item dropdown dropdown-authentication">
                    <a class="nav-link dropdown-toggle no-caret" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="media">
                            ...
                            <div class="media-body">
                                <span>{{ Auth::user()->fname}}<i class="zmdi zmdi-chevron-down"></i></span>
                            </div>
                        </div>
                    </a>
                    <div class="dropdown-menu dropdown-menu-right" data-dropdown-in="flipInX" data-dropdown-out="flipOutX">
                        <a class="dropdown-item" href="{{ route('userprofile.index')}}"><i class="dropdown-icon zmdi zmdi-account"></i><span>Profile</span></a>
                        <a class="dropdown-item" href="{{ route('users.index')}}"><i class="dropdown-icon zmdi zmdi-card"></i><span>Home</span></a>
                ...
                {{--     <form action="{{ route('users.destroy')}}" method="POST">
                            @csrf
                      <button type="submit"> logg 
                        <a class="dropdown-item" href="">
                        <i class="dropdown-icon zmdi zmdi-power"></i><span>Log out</span></a>
                      </button>
                     </form>  --}}
                    </div>
                </li>
                            ...
                            <ul id="dash_drp" class="nav flex-column collapse collapse-level-1">
                                <li class="nav-item">
                                    <ul class="nav flex-column">
                                      ...
                                      {{--  <li class="nav-item">
                                            <a class="nav-link" href="{{ route('doctorsAppointments.index')}}">Doctor Appointments</a>
                                        </li>
										<li class="nav-item">
                                            <a class="nav-link" href="{{ route('userAppointment.index')}}">Patients Appointments</a>
                                        </li>
										<li class="nav-item">
                                            <a class="nav-link" href="{{ route('userRecord.index')}}">users records</a>
                                        </li>   --}}
									</ul>
                                </li>
                            </ul>
...
<script src="{{ asset('admin-dash/vendors/popper.js/dist/umd/popper.min.js') }}"></script>
<script src="{{ asset('admin-dash/vendors/bootstrap/dist/js/bootstrap.min.js') }}"></script>

<!-- Slimscroll JavaScript -->
<script src="{{ asset('admin-dash/dist/js/jquery.slimscroll.js') }}"></script>

<!-- Fancy Dropdown JS -->
<script src="{{ asset('admin-dash/dist/js/dropdown-bootstrap-extended.js') }}"></script>

<!-- FeatherIcons JavaScript -->
<script src="{{ asset('admin-dash/dist/js/feather.min.js') }}"></script>

<!-- Toggles JavaScript -->
<script src="{{ asset('admin-dash/vendors/jquery-toggles/toggles.min.js') }}"></script>
<script src="{{ asset('admin-dash/dist/js/toggle-data.js') }}"></script>

<!-- Counter Animation JavaScript -->
<script src="{{ asset('admin-dash/vendors/waypoints/lib/jquery.waypoints.min.js') }}"></script>
<script src="{{ asset('admin-dash/vendors/jquery.counterup/jquery.counterup.min.js') }}"></script>
...
<!-- EChartJS JavaScript -->
<script src="{{ asset('admin-dash/vendors/echarts/dist/echarts-en.min.js') }}"></script>

<!-- Sparkline JavaScript -->
<script src="{{ asset('admin-dash/vendors/jquery.sparkline/dist/jquery.sparkline.min.js') }}"></script>

<!-- Vector Maps JavaScript -->
<script src="{{ asset('admin-dash/vendors/vectormap/jquery-jvectormap-2.0.3.min.js') }}"></script>
<script src="{{ asset('admin-dash/vendors/vectormap/jquery-jvectormap-world-mill-en.js') }}"></script>
<script src="{{ asset('admin-dash/dist/js/vectormap-data.js') }}"></script>

<!-- Owl JavaScript -->
<script src="{{ asset('admin-dash/vendors/owl.carousel/dist/owl.carousel.min.js') }}"></script>

<!-- Toastr JS -->
<script src="{{ asset('admin-dash/vendors/jquery-toast-plugin/dist/jquery.toast.min.js') }}"></script>

<!-- Init JavaScript -->
<script src="{{ asset('admin-dash/dist/js/init.js') }}"></script>
<script src="{{ asset('admin-dash/dist/js/dashboard-data.js') }}"></script>
