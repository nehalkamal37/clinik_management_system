                  ...
                  <div class="card-body p-3 p-md-4 p-xl-5">
                      ...
                      <div class="col-12">
                        <div class="mb-5">
                          <div class="text-center mb-4">
                            <a href="#!">
                              <img src="{{ asset('logoo.jpg')}}" alt="BootstrapBrain Logo" width="175" height="57">
                            </a>
                          </div>
                          <h2 class="h4 text-center">Registration user</h2>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                    ...
                    <form method="POST" action="{{ route('register') }}">
                       ...
                       <div class="row gy-3 overflow-hidden">
                        ...
                        <div class="col-12">
                            <div class="form-floating mb-3">
                              <input type="text" class="form-control" name="lname" id="firstName" placeholder="First Name" required>
